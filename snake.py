...
class snake(object):
    ...
    def getSuccessors(self, current_pos):  # more like surrounding grid positions
        ...
        successors = []  # tuple of states (position), actions ("UP", "DOWN", "LEFT", "RIGHT"), cost (grid pos, direction to get there, cost to get there)
        x, y = current_pos
...
def main():
    ...
    while flag:
        ...
        #     print(f'{list(map(lambda z: z.pos, s.body[x + 1:]))} - {s.body[x].pos}')
